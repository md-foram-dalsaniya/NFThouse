        ...
        <div className={classes.container}>
            <div className={classes.wrapper}>
                <div className={classes.profile}>
                    ...
                    <img alt='Profile' className={classes.userProfileImg} src={user?.profileImg ? `http://localhost:5000/images/${user?.profileImg}` : person} />
                                    ...
                                    <div key={listedProperty._id} className={classes.property}>
                                        ...
                                        <div className={classes.details}>
                                            <div className={classes.priceAndOwner}>
                                                ...
                                                <img alt='Profile' src={user?.profileImg ? `http://localhost:5000/images/${user?.profileImg}` : person} className={classes.owner} />
                                            </div>
