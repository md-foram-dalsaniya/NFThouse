    ...
    return (
        <div key={property._id} className={classes.property}>
            <Link to={`/propertyDetail/${property._id}`} className={classes.imgContainer}>
                <img src={`https://nfthouse-backend.onrender.com/images/${property?.img}`} alt="property" />
            </Link>
            <div className={classes.details}>
                <div className={classes.priceAndOwner}>
                    <span className={classes.price}>$ {property.price}</span>
                    <img alt='profile' src={ownerProfileImg ? `https://nfthouse-backend.onrender.com/images/${ownerProfileImg}` : person} className={classes.owner} />
                </div>
