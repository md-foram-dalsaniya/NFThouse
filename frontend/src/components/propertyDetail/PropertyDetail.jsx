...
const PropertyDetail = () => {
  ...
  return (
    <div className={classes.container}>
      ...
      {propertyDetail ? <>
        <div className={classes.wrapper}>
          <div className={classes.left}>
            <img alt='Property' src={`https://nfthouse-backend.onrender.com/images/${propertyDetail?.img}`} />
          </div>
              ...
              <div className={classes.priceAndOwner}>
                ...
                <span style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  Owner: {propertyDetail?.currentOwner?.profileImg
                    ? (
                      <img alt='Owner Profile ' src={`https://nfthouse-backend.onrender.com/images/${propertyDetail?.currentOwner?.profileImg}`} className={classes.owner} />
                    ) : (
      ...
      </> : <Deloader style={{ textAlign: 'center' }} />}
      ...
      <div className={classes.commentSection}>
        ...
        {user?._id != null && <div className={classes.commentInput}>
          <img alt='Profile' src={`https://nfthouse-backend.onrender.com/images/${user?.profileImg}`} />
